...
Copy-Item ".\Droptop\@Resources\Fonts\$fontname.ttf" -Destination ".\Droptop\@Resources\Scripts\AppBuilder\ThemeTemplate\Skins\Droptop\@Resources\Fonts" -Recurse
...
Copy-Item ".\Droptop Folders\Other files\Themes\ThemeMeasures.inc" -Destination ".\Droptop\@Resources\Scripts\AppBuilder\ThemeTemplate\Skins\Droptop Folders\Other files\Themes" -Recurse
