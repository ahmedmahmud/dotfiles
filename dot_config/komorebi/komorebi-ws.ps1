...
& $komorebic workspace-name 1 0 "`u{fb6e} "
& $komorebic workspace-name 1 1 "`u{f26b} "
& $komorebic workspace-name 1 2 "`u{f668} "
& $komorebic workspace-name 1 3 "`u{e615} "
& $komorebic workspace-name 1 4 "`u{f6e6} "
& $komorebic workspace-name 1 5 "`u{f962} "
& $komorebic workspace-name 1 6 "`u{f1b6} "
& $komorebic workspace-name 1 7 "`u{f232} "
& $komorebic workspace-name 1 8 "`u{f1bc} "
